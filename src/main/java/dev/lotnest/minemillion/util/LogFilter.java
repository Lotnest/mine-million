...
public class LogFilter implements Filter {
    ...
    private static final String[] FILTERED_MESSAGES = new String[]{
            "[MineMillion] [ACF] Enabled Asynchronous Tab Completion Support!",
            "[MineMillion] [ACF] Enabled Brigadier Support!"
    };
